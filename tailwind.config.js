...
export default {
  ...
  theme: {
    ...
    backgroundImage: {
      "cosmic-bg-chat-sender":
        "url('/src/assets/images/cosmic-chat-sender-bg.svg')",
      "cosmic-bg-chat-background":
        "url('/src/assets/background/cosmic-chat-background.svg')",
      "cosmic-bg-landing-page-background":
        "url('/src/assets/background/cosmic-landing-page-bg-image.svg')",
      "cosmic-landing-page-card-bg":
        "url('/src/assets/background/cosmic-card-bg.svg')",
      "cosmic-testimonial": "url('/src/assets/images/testimonialViewBg.svg')",
      "cosmic-footer-bg":
        "url('/src/assets/images/cosmic-footer-bg-image.svg')",
    },
