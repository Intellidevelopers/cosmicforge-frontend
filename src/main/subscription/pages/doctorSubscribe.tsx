...
const DoctorSubscribe = () => {
  ...
  useMemo(() => {
    ...
    if (subscription) {
      ...
      const formatedSubscriptionDetails = subscription.generalSubscriptionDetails?.map((plan) => {
  ...
  return (
    <div className="overflow-y-auto mb-8 cursor-default">
      ...
      <p className="m-5 bg-white w-fit p-3 shadow-md rounded-md" onClick={() => {
      ...
      <div className={ `${openAlertModal ? 'flex':'hidden'} absolute h-screen w-screen bg-black bg-opacity-15 top-0   md:ps-[30%] justify-center md:justify-normal place-items-center `}>
