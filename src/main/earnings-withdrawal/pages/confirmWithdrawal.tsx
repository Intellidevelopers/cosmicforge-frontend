    ...
    <div className="w-screen h-screen flex items-center justify-center">
        <div className="max-w-[700px] h-fit items-center justify-center w-full gap-4 flex flex-col p-4 shadow-md">
            ...
            <div className="flex flex-col justify-center items-center">
                <p className='text-center'>Are you sure you want to continue with the withdrawal?</p>
            ...
            <div className="flex justify-around gap-8">
                ...
                <button type="button" className='rounded-md text-white bg-cosmic-primary-color py-2 px-4'>Confirm</button>
            </div>
        </div>
    </div>
  )
