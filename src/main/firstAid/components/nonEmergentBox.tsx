...
const NonEmergentBox = ({image,title, path}:props) => {
  ...
  return (
    <div className='flex justify-start hover:scale-[101%] transition-all duration-[300] ease-in-out items-center h-[85px] border bg-white px-[7px] rounded-md w-full shadow-md cursor-pointer gap-2'
    onClick={()=>nav(path)}
    >
