        ...
        <div className=" font-poppins w-screen h-screen">
            ...
            <div className='fixed flex flex-col md:gap-2 px-[10px] md:py-[10px] py-[10px] text-center md:justify-start justify-around items-center md:rounded-[3px] rounded-[20px] md:h-[180px] h-[300px] bottom-[5%] w-[95%] ml-[2.5%] bg-white/20 backdrop-blur-[5px]'>
                ...
                <div className='flex flex-row w-full justify-center gap-3 items-center border-1 border-red-500'>
                    { ( currentSlide <= 2 ) && ( 
                        <Link className='w-[22%] hover:scale-[105%] flex flex-col justify-center items-center rounded-[3px] hover:text-[#272EA7] h-[40px] bg-transparent text-white font-bold text-[17px]' to={'/selectRole'}>
                            Skip
                        </Link>
                    )}

                    { currentSlide === 3 ? (
                        <Link className='md:w-[22%] hover:scale-[105%] flex flex-col justify-center items-center  w-[50%] hover:bg-[#272EA7]/80 rounded-[3px] h-[40px] bg-[#272EA7] text-white font-bold text-[17px]' to={'/selectRole'}>
                           Get Started
                        </Link>
                    ):(
