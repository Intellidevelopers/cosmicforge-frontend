...
const  SlideScreen: React.FC<ComponentProps> =  ( { banner } ) =>{ 
    ...
    return (
        <div className="w-screen h-screen">
            ...
            <div className='fixed flex flex-col md:gap-2 px-[10px] md:py-0 py-[10px] text-center md:justify-start justify-around items-center md:rounded-[3px] rounded-[30px] md:h-[180px] h-[300px] bottom-[5%] w-[95%] ml-[2.5%] bg-white/20 backdrop-blur-[5px]'>
                ...
                <div className='md:text-[28px] text-[23px] font-extrabold'>
