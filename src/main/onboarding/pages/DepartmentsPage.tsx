...
const DepartmentsPage = () => {
    ...
    return <div className="w-full font-poppins cursor-default">
       <div className='w-full h-fit relative'>
     <img src={deptBg} alt='bg-image' />
     <div className='absolute bottom-8 left-8 flex gap-2 justify-center place-items-center text-white bg-cosmic-white-light-0.2 p-2  cursor-default' onClick={()=>{
        navigate('/')
     }}>
       ...
       <div className='w-full p-8'>
        ...
        <div>
           {
            departments.length>0 && departments.map((dep:any,i:number)=>(
                <CustomDepartmentCard  key={i} icon={dep.image} title={dep.name} backgroundImage={dep.backgroundImage} bodyText={dep.bodyText} />
