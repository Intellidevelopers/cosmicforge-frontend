...
const Testimonials = () => {
  ...
  return (
    <div className="bg-testimonials py-16">
      <div className="bg-[#272EA7] max-w-[80%] mx-auto">
        ...
        <div className="w-full overflow-x-auto scroll-smooth no-scrollbar px-16">
          <div
            // className="grid grid-cols-4 gap-4 px-4 py-6
            // snap-x snap-mandatory
            // w-max"
            className="grid grid-cols-3 items-start gap-8 pb-16"
          >
