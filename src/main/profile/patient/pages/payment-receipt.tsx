  ...
  return (
    <div className='h-screen w-screen main  items-center flex flex-col  '>
        <div className=' max-w-[600px] w-full flex flex-col gap-4'>
            ...
            <img src={logo} alt="CosmicForge logo"  className=' self-left h-[2rem]' />
            </div>
            <div className="flex flex-col justify-center items-center">
                <p className="font-extrabold text-cosmic-primary-color text-xl">N23,000.00</p>
            ...
            <div className="flex flex-col mt-2 gap-2">
                <div className="flex flex-col p-2">
                    <div className="flex justify-between">
                        <p className="px-2 xs:text-sm  font-extralight">Transaction type:</p>
                ...
                <div className="flex flex-col p-2">
                    <div className="flex justify-between">
                        ...
                        <div className="flex flex-col items-end">
                            <p className="px-2 xs:text-sm  font-bold">Chastain Park Hospital</p>
                            <p className="px-2 xs:text-sm  font-extralight">GLB | 1234567890</p>
                        </div>
                    </div>
                </div>
                <div className="flex flex-col p-2">
                    <div className="flex justify-between">
                        <p className="px-2 xs:text-sm  font-extralight">Transaction ID:</p>
                ...
                <div className="flex flex-col p-2">
                    <div className="flex justify-between">
                        <p className="px-2 xs:text-sm  font-extralight">Transaction Date:</p>
                ...
                <div className="flex flex-col p-2">
                    <div className="flex justify-between">
                        ...
                        <div className="flex flex-col items-end">
                            <p className="px-2 xs:text-sm  font-bold">Grace Jennifer Williams</p>
                            <p className="px-2 xs:text-sm  font-extralight">GLB | 1234567890</p>
                        </div>
                    </div>
                </div>
                <div className="flex flex-col p-2">
                    <div className="flex justify-between">
                        <p className="px-2 xs:text-sm  font-extralight">Payment Method:</p>
                        <p className="px-2 xs:text-sm  font-bold">Bank Transfer</p>
                    </div>
                </div>
                <div className="flex flex-col p-2">
                    <div className="flex justify-between">
                        <p className="px-2 xs:text-sm  font-extralight">Payment Status:</p>
