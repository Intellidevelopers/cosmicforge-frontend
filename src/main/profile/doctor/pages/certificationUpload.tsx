...
const CertificationUpload = () => {
  ...
  const certificateDetails = useSelector(
    (state: RootReducer) =>
      state.doctorCertificateAndLicence.certificationDetails,
  );
    ...
    <div>
      ...
      <div className="p-4 flex flex-col gap-4">
        ...
        <button
          ...
          onClick={() => {
            navigate("/doctor/certificate-details-upload");
          }}
        >
          Upload New
        </button>
        ...
        <div className={`bg-white  rounded-md shadow-md  p-4 `}>
          ...
          >
            {
              <img
                src={certificateDetails?.certificate ?? "/"}
                alt="No certificate uploaded yet"
                className="w-full bg-black bg-opacity-30 object-cover max-h-[60dvh]"
              />
            }
          ...
          <div className="flex justify-between flex-wrap items-center border-t border-black mt-2 w-full px-4">
            ...
            <p className="font-bold">
              {certificateDetails?.fullName ?? "not uploaded yet"}
            </p>
