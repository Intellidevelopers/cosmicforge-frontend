    ...
    <div className="overflow-y-scroll">
      ...
      <div className="justify-center items-center flex flex-col ">
        ...
        <div className="flex w-full flex-col justify-center items-center h-full mb-8">
          <div className="flex-col w-[90%] h-full flex gap-2">
            <div className="flex items-center justify-start rounded-md  shadow-black  shadow-sm p-2 bg-white">
              <img
                src={patientIcon}
                alt="Patients"
                className="w-12 h-12 border-r-2 p-2"
              />
              <p className="font-bold p-2">Patients</p>
            </div>

            <div
              className="flex items-center justify-start rounded-md shadow-black  shadow-sm p-2 bg-white"
              onClick={() => {
            ...
            <div
              className="flex items-center justify-start rounded-md shadow-black  shadow-sm  p-2 bg-white"
              onClick={() => {
                navigate("/doctor/certifications");
              }}
            >
              <img
                src={certification}
          ...
          <div className="flex-col w-[90%] h-full flex"></div>
        </div>
      </div>
    </div>
  );
