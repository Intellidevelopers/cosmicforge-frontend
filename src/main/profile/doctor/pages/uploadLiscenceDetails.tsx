    ...
    <div className="bg-white relative z-1">
      ...
      <div className="p-4 space-y-4">
        <div className="flex flex-col gap-1  ">
          <div className="flex flex-col gap-1">
            <label htmlFor="fullName" className="font-bold">Type of licence</label>
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="certificateNo" className="font-bold">Licence No</label>
            <input type="text" name="certificateNo" id="certificateNo" className="border-black p-2 border rounded-md"
              onChange={(e) => {
                setErrorMessage('')
                setFormDetails({ ...formDetails, licenceNo: e.target.value })
              }}
            />
          </div>
          ...
          <div className="flex flex-col gap-1 mt-2">
            <label htmlFor="license" className="font-bold">License</label>
          ...
          <div className="flex flex-col gap-1 mt-4">
            <label htmlFor="license" className="font-bold">Hold the licence and take a photo</label>
            <input type="file" name="date" id="date" accept=".png, .jpg, .jpeg, .gif, .svg" className="border-black p-2 border rounded-md"
              onChange={async (e) => {
                ...
                try {
                  ...
                  if (e.target.files) {
                    ...
                    const imageBase64 = await getImageBase64String(e.target.files[0])
                    setFormDetails({ ...formDetails, photoWithLicence: imageBase64 })
