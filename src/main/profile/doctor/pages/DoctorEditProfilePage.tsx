...
const DoctorEditProfilePage = () => {
  ...
  const [doctorEditProfileDetails, setDoctorEditProfileDetails] =
    useState<DoctorEditProfileProps>({
      ...
      currency:
        user.data?.profile?.currency === "NGN" ||
        user.data?.profile?.currency === "USD"
          ? user.data?.profile?.currency
          : "NGN",
      experience: {
        hospitalName: user.data?.profile?.experience?.hospitalName ?? "",
        NoOfPatientTreated:
          user.data?.profile?.experience?.NoOfPatientTreated ?? "",
        specializationAndDepartment:
          user.data?.profile?.experience?.specializationAndDepartment ?? "",
  ...
  const [doctorsDep, setDoctorsDep] =
  ...
  return (
    <div className="w-full h-full cursor-default overflow-y-hidden bg-[#F5F5F5] ">
      <div
        className={`${successfulUpdate ? "flex" : "hidden"}  absolute bg-gray-500 bg-opacity-30 flex justify-center place-items-center w-full h-screen  bottom-0 z-[200]`}
      >
        <div className="bg-white w-[80%] h-[60%] rounded-md flex flex-col place-items-center gap-12 relative">
          ...
          <p
            className="bg-cosmic-primary-color text-white  rounded-md absolute right-4 bottom-2 p-4 w-[100px] text-center"
            onClick={() => {
      ...
      <div
        className={`   ${loading || errorMessage ? "flex" : "hidden"} absolute bg-gray-500 bg-opacity-30 flex justify-center place-items-center w-full h-screen bottom-50 z-[200]`}
      >
        <div className="bg-white w-[80%] h-[60%] rounded-md flex flex-col place-items-center gap-12 relative">
      ...
      <div className="  w-full h-dvh  relative ">
        <div
          className="w-full md:flex place-items-center gap-2 m-4 hidden "
          onClick={() => {
        ...
        <div className="w-full flex flex-col place-items-center  mt-2 relative  h-[100vh] overflow-y-auto pb-20">
          <div className="cursor-default md:w-[325px] md:ms-12 relative ">
            <img
              src={doctorEditProfileDetails?.profilePicture ?? "/"}
              className="w-[200px] h-[200px] bg-black bg-opacity-40 rounded-full"
            />

            <div className="md:absolute mt-2  md:top-[110px] right-0 ">
              <p
                className="bg-white m-1 rounded-md p-1 text-center"
                onClick={() => {
                  if (imageFileRef) {
              ...
              <p className="bg-white m-1  rounded-md p-1 text-center">
                Remove Image
              </p>
              <input
                ref={imageFileRef}
                ...
                onChange={async (e) => {
                  if (e.target.files) {
                    try {
                      const image = await getImageBase64String(
                        e?.target?.files[0],
                      );
          ...
          <div className="w-full mt-4  p-6">
            <div className="w-full flex flex-col gap-2">
              ...
              <input
                type="text"
                value={doctorEditProfileDetails.fullName}
            ...
            <div className="w-full flex flex-col gap-2 mt-8">
              ...
              <input
                type="lastName"
                value={doctorEditProfileDetails.lastName}
                className="w-full bg-transparent border p-2 rounded-md"
                id="lastName"
                onChange={(e) => {
                  setDoctorEditProfileDetails({
            ...
            <div className="w-full flex flex-col gap-2 mt-8">
              ...
              <input
                type="text"
                value={doctorEditProfileDetails.mobileNo}
                className="w-full bg-transparent border p-2 rounded-md"
                id="mobileNo"
                onChange={(e) => {
                  setDoctorEditProfileDetails({
            ...
            <div className="w-full flex flex-col gap-2 mt-8">
              ...
              <input
                type="text"
                value={doctorEditProfileDetails.specialization}
                className="w-full bg-transparent border p-2 rounded-md"
                id="specialization"
                onChange={(e) => {
                  setDoctorEditProfileDetails({
            ...
            <div className="w-full flex flex-col gap-2 mt-8">
              ...
              <input
                type="text"
                value={doctorEditProfileDetails.currentClinic}
                className="w-full bg-transparent border p-2 rounded-md"
                id="currentClinic"
                onChange={(e) => {
                  setDoctorEditProfileDetails({
            ...
            <div className="w-full flex flex-col gap-2 mt-8">
              ...
              <select
                value={doctorEditProfileDetails.department}
                className="w-full bg-transparent border p-2 rounded-md"
                id="department"
                onChange={(e) => {
                  setDoctorEditProfileDetails({
            ...
            <div className="w-full flex flex-col gap-2 mt-8">
              ...
              <input
                value={doctorEditProfileDetails.bio}
                type="text"
                className="w-full bg-transparent border p-2 rounded-md h-[100px]"
                id="bio"
                onChange={(e) => {
                  setDoctorEditProfileDetails({
                    ...doctorEditProfileDetails,
            ...
            <div className="w-full flex flex-col gap-2 mt-8">
              ...
              <p>
                <span className="font-bold">Note:</span> currency can only be
                selected once.
              </p>
              <select
                className="currency w-fit pe-8 pt-2 text-balance bg-transparent"
                disabled={
                  user.data?.profile &&
                  (user.data?.profile.currency === "NGN" ||
                    user.data?.profile.currency === "USD")
                }
                value={doctorEditProfileDetails.currency}
                onChange={(e) => {
                  setDoctorEditProfileDetails({
                    ...doctorEditProfileDetails,
              ...
              <label className="font-bold mt-2">
                Standard Consultation Fee(15 mins or less)
              </label>
              <input
                onKeyDown={(e) => {
                  if (
                    doctorEditProfileDetails.pricing === "0" &&
                ...
                value={doctorEditProfileDetails.pricing}
                type="text"
                className="w-full bg-transparent border p-2 rounded-md"
                id="pricing"
                onChange={(e) => {
                  if (
                    Number.isInteger(Number(e.target.value.replace(/[,]/g, "")))
                  ) {
                    setDoctorEditProfileDetails({
                      ...doctorEditProfileDetails,
                      pricing: new Intl.NumberFormat().format(
              ...
              <label className="font-bold mt-2">
                Standard Consultation Fee(30 mins or less)
              </label>
              <input
                value={doctorEditProfileDetails.pricingForThirtyMins}
                type="text"
                className="w-full bg-transparent border p-2 rounded-md"
                id="pricing"
                onChange={(e) => {
                  if (
                    ...
                    setDoctorEditProfileDetails({
                      ...doctorEditProfileDetails,
                      pricingForThirtyMins: new Intl.NumberFormat().format(
                        Number(e.target.value.replace(/[,]/g, "")),
                      ),
                    });
                  }
            ...
            <div className="w-full mt-8">
              ...
              <div className="w-full grid grid-cols-2 gap-2">
                <div className="w-full col-span-2 md:col-span-1 flex flex-col gap-2 mt-8">
                  ...
                  <input
                    value={doctorEditProfileDetails.experience?.hospitalName}
                    type="text"
                    className="w-full bg-transparent border p-2 rounded-md"
                    id="hospitalName"
                    onChange={(e) => {
                ...
                <div className="w-full col-span-2 md:col-span-1 flex flex-col gap-2 mt-8">
                  ...
                  <input
                    value={
                      doctorEditProfileDetails.experience?.NoOfPatientTreated
                    }
                    type="text"
                    className="w-full bg-transparent border p-2 rounded-md "
                    id="noOfPatientTreated"
                    onChange={(e) => {
                      setDoctorEditProfileDetails({
                        ...doctorEditProfileDetails,
                        experience: {
              ...
              <div className="w-full grid grid-cols-2 gap-2">
                ...
                <div className="w-full col-span-2 md:col-span-1 flex flex-col gap-2 mt-8">
                  <label
                    htmlFor="startAndEndDate"
                    className="text-[12px] md:text-[16px]"
                  >
                    Start d/m/y - End d/m/y
                  </label>
                  <input
                    value={doctorEditProfileDetails.experience?.date}
                    type="text"
                    className="w-full bg-transparent border p-2 rounded-md"
                    id="startAndEndDate"
                    onChange={(e) => {
            ...
            <div className="w-full mt-8">
              <p className="text-cosmic-primary-color font-bold pb-2">
                Working hours
              </p>
              ...
              <div className="w-full grid grid-cols-2 gap-2">
                <div className="w-full flex flex-col gap-2 mt-2">
                  ...
                  <select
                    value={
                      doctorEditProfileDetails.workingHours?.day?.split(
                        "-",
                      )[0] ?? doctorEditProfileDetails.workingHours?.day
                    }
                    className="w-full bg-transparent border p-2 rounded-md"
                    id="workingFrom"
                    onChange={(e) => {
                ...
                <div className="w-full flex flex-col gap-2 mt-2">
                  ...
                  <select
                    value={
                      doctorEditProfileDetails.workingHours?.day?.split("-")[1]
                    }
                    className="w-full bg-transparent border p-2 rounded-md"
                    id="workingTo"
                    onChange={(e) => {
                      setDoctorEditProfileDetails({
                        ...
                        workingHours: {
                          ...doctorEditProfileDetails?.workingHours,
                          day: doctorEditProfileDetails?.workingHours?.day
                            ?.concat("-")
              ...
              <div className="w-full grid grid-cols-2 gap-2">
                <div className="w-full flex flex-col gap-2 mt-4">
                  ...
                  <select
                    value={
                      doctorEditProfileDetails.workingHours?.time?.split(
                        "-",
                      )[0] ?? doctorEditProfileDetails.workingHours?.time
                    }
                    className="w-full bg-transparent border p-2 rounded-md"
                    id="timeFrom"
                    onChange={(e) => {
                ...
                <div className="w-full flex flex-col gap-2 mt-4">
                  ...
                  <select
                    value={
                      doctorEditProfileDetails.workingHours?.time?.split("-")[1]
                    }
                    className="w-full bg-transparent border p-2 rounded-md"
                    id="timeTo"
                    onChange={(e) => {
                      setDoctorEditProfileDetails({
                        ...
                        workingHours: {
                          ...doctorEditProfileDetails?.workingHours,
                          time: doctorEditProfileDetails?.workingHours?.time
                            ?.concat("-")
                            .concat(e.target.value),
                        },
                      });
            ...
            <div className="w-full p-4 flex justify-center  cursor-default m-2 ">
              <p
                className="bg-cosmic-primary-color text-white p-2 m-2 rounded-md"
                onClick={async () => {
                  let updatedData = doctorEditProfileDetails;
                  if (
                    doctorEditProfileDetails.profilePicture?.includes("https")
                  ) {
                    let { profilePicture, ...newData } =
                      doctorEditProfileDetails;

                    updatedData = newData;
                  }

                  const data = Object.entries(updatedData).every(
                    ([, value], _) => {
                      return (
                  ...
                  if (
                    !updatedData.pricingForThirtyMins ||
                    updatedData.pricingForThirtyMins === "0"
                  ) {
                  ...
                  if (
                    updatedData.workingHours?.time &&
                    updatedData.workingHours?.time?.split("-").length <= 1
                  ) {
                  ...
                  if (
                    updatedData.workingHours?.day &&
                    updatedData.workingHours?.day?.split("-").length <= 0
                  ) {
                  ...
                  if (
                    ...
                    setErrorMessage(
                      "Please fill the department,time and day fields ",
                    );
                    return;
                  }
