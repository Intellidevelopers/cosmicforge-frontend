...
let UploadCertificationFirstPage = () => {
  ...
  return (
    <div className="flex flex-col gap-5  ">
      ...
      <div className="flex flex-col gap-1">
        <label htmlFor="certificateNo" className="">
          Certificate No:
        </label>
        <input
          type="text"
            ...
            if (e.target.files)
              dispatch(
                cacheDoctorCertificateAndLicenceDetailsForUpload({
                  uploadCertificationDetails: {
                    ...certificateDetails!!,
                    certificate: await getImageBase64String(
                      e.target.files[0]!!,
                    ),
                  },
                }),
      ...
      <div className="flex flex-col gap-1  ">
        <label htmlFor="cfs" className="">
          Hold Ceertificate and snap{" "}
        </label>
            ...
            if (e.target.files)
              dispatch(
                cacheDoctorCertificateAndLicenceDetailsForUpload({
                  uploadCertificationDetails: {
                    ...certificateDetails!!,
                    photoWithCertification: await getImageBase64String(
                      e.target.files[0]!!,
                    ),
                  },
                }),
