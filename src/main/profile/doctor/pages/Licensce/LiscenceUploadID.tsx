...
let LiscenceUploadID = () => {
  ...
  return (
    <div className="flex flex-col gap-5  ">
      ...
      <div className="flex flex-col gap-1  ">
        <label htmlFor="LD Type" className="">
          I.D Type
        </label>
      ...
      <div className="flex flex-col gap-1">
        <label htmlFor="LD Number" className="">
          I.D Number
        </label>
        <input
          type="text"
      ...
      <div className="flex flex-col gap-1">
        <label htmlFor="Holder Name" className="">
          Holder Name
        </label>
        <input
          type="text"
            ...
            if (e.target.files)
              dispatch(
                cacheDoctorCertificateAndLicenceDetailsForUpload({
                  uploadLicenseDetails: {
                    ...liscenseDetails!!,
                    documentImage: await getImageBase64String(
                      e.target.files[0]!!,
                    ),
                  },
                }),
      ...
      <div className="flex flex-col gap-1  ">
        <label htmlFor="ldPhoto" className="">
          Hold I.D and take a picture{" "}
        </label>
            ...
            if (e.target.files)
              dispatch(
                cacheDoctorCertificateAndLicenceDetailsForUpload({
                  uploadLicenseDetails: {
                    ...liscenseDetails!!,
                    pictureWithDocument: await getImageBase64String(
                      e.target.files[0]!!,
                    ),
                  },
                }),
      ...
      <p className="p-1 text-sm ">
        To verify your License, we require you to provide a government approved
        ID copy. This will validate your operations with Cosmicforge Health
        Net.{" "}
      </p>
      <p className="p-1 text-sm ">
        <b>Please Note;</b> Your ID is subject to verification. We will reach
        out to you via email once verification is completed and confirmed.
      </p>
