...
const LicenceFaceId = () => {
    ...
    return <div className="w-full min-h-[50vh] ">
        <p>To complete your License verification, we require you to verify your face. This will validate your operations with Cosmicforge Health Net.</p>
