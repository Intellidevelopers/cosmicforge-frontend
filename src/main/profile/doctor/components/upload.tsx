      ...
      <div className="flex flex-col  justify-between items-center bg-white w-[60%]  shadow-md shadow-black  z-[2000]    max-w-[600px] h-[400px] p-4">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          {uploadedFile ? (
            ...
            <div>
              <label htmlFor="liscence" className="underline mr-2">
                Upload File
              </label>
        ...
        <div className="flex flex-col w-full border-t border-gray-400 gap-4">
          <div className="flex justify-between w-full">
            <p className="text-gray-400 text-sm">
              SUPPORTED FORMATS: XLS, XLSX, PDF, DOXT
            </p>
            <p className="text-gray-400 text-sm">Maximum size: 30mb</p>
          </div>
          <div className="flex justify-between w-full">
            <div className="flex h-fit">
              <p className="text-gray-400 text-center rounded-[50%] border border-gray-400 w-6">
                !
              </p>
            ...
            <div className="flex gap-2">
              <button
                type="button"
                className="rounded-md font-bold border border-black p-2"
                onClick={hideComp}
              >
                Cancel
              </button>
