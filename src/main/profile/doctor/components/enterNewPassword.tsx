...
const EnterNewPassword:React.FC<props> = ( { forwardFunction } ) => {
    const validateInput = () => {
                ...
                <div className="flex flex-col items-center justify-start w-[100%] h-[100%]">
                    ...
                    <div className="h-[330px] flex flex-col justify-start pt-[25px] md:w-[50%] w-[90%] items-center gap-4 bg-white rounded-[10px] mt-[50px]">
                        ...
                        <div className="flex flex-col md:w-[80%] w-[90%] gap-1">
                            <span>Password</span>
                            <input type="password" className="outline-none bg-gray-300 rounded-[7px] h-[45px] px-2 w-[100%]" placeholder="Enter password"/>
                        </div>
                        <div className="flex flex-col md:w-[80%] w-[90%]  gap-1">
                            <span>Confirm Password</span>
                            <input type="password" className="outline-none bg-gray-300 h-[45px] rounded-[7px] px-2 w-[100%]" placeholder="Enter password again"/>
                        </div>
