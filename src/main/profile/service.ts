...
export const updatePatientProfile = async (
  ...
  const response = await fetch(
    `${import.meta.env.VITE_BASE_REST_URL}/user/patient/update-profile`,
    {
      method: "put",
      headers: {
...
export const updateDoctorProfile = async (
  data: DoctorEditProfileProps,
  token: string,
) => {
  const response = await fetch(
    `${import.meta.env.VITE_BASE_REST_URL}/user/medics/update-profile`,
    {
      method: "put",
      headers: {
        Authorization: `Bearer ${token}`,
...
export const getDoctorDeparmentsForLandingPage = async () => {
  const response = await fetch(
    `${import.meta.env.VITE_BASE_REST_URL}/medics/doctor/departments/all`,
    {
      method: "get",
      headers: {
        "Content-Type": "application/json",
...
export const uploadLicense = async (
  ...
  const response = await fetch(
    `${import.meta.env.VITE_BASE_REST_URL}/user/medics/certification/upload`,
    {
      signal,
      method: "post",
      headers: {
