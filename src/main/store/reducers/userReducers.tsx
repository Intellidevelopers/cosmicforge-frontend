...
const userSlice = createSlice({
  ...
  reducers: {
    authenticateUser(state, action: PayloadAction<UserProps>) {
      (state.isAunthenticated =
        action.payload.isAunthenticated ?? state.isAunthenticated),
      ...
      state.emailValidated =
        action.payload.emailValidated ?? state.emailValidated;
      state.keepMeSignedIn =
        action.payload.keepMeSignedIn ?? state.keepMeSignedIn;
