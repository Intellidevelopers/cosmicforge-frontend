...
const ProductCard = (props: FavoriteItem) => {
  return (
    <div className="xs:max-w-[200px] w-[100%] border p-2 rounded-md space-y-1.5  self-center justify-self-center max-w-[170px] md:w-full md:max-w-[240px] md:min-w-[190px] flex flex-1 flex-col justify-center items-center">
