...
const AppointmentInfoPage = () => {
  ...
  return (
    <div className="w-full font-poppins overflow-hidden flex">
      <HomeSideBarMobile />
      ...
      <div className="w-full">
        ...
        <div className=" h-[600px]  relative bg-[#F5F5F5] bg-opacity-50  cursor-default overflow-y-auto   font-poppins w-full p-3  ">
          <div
            className=" place-items-center gap-3 hidden md:flex m-8 "
            onClick={() => {
              navigate(-1);
            }}
          >
...
*/}
          ...
          <div className="w-full p-8">
            <div className="w-full   p-3 flex gap-2 relative bg-white rounded-sm shadow-black shadow-sm ">
              <div className="w-full   flex flex-col justify-center gap-1 relative">
                <p className="w-full font-light text-[14px] md:text-[16px] ">
                  Time:<span>{details.dateInFull.split(",")[1]}</span>
                </p>

                <p className="w-full text-[14px] md:text-[16px] font-light">
                  Date:<span>{details.dateInFull.split(",")[0]}</span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full mt-3 h-[200px] flex justify-center place-items-center">
            <div className="bg-green-600 bg-opacity-20 p-3">
              <p className=" text-cosmic-color-green-color">
                {details.paymentStatus && details.paymentStatus === "success"
                  ? "Confirmed"
          ...
          <div>
            <div className=" text-white flex justify-center gap-8">
              <div
                className="w-[300px] bg-cosmic-primary-color text-[12px] md:text-[14px] p-2 rounded-md text-center"
                onClick={() => {
