    ...
    return <div className="w-full font-poppins overflow-hidden">
        ...
        <div className=" h-[600px] md:ps-[250px] relative bg-[#F5F5F5] bg-opacity-50  cursor-default overflow-y-auto   font-poppins w-full p-3  ">
            ...
            <div className="w-full ps-8 pe-8">
                ...
                <div className="bg-white w-full h-fit flex  relative shadow-black shadow-sm  ">
                    ...
                    <div className=" w-[180px] h-[150px]  relative border border-cosmic-color-border-color rounded-md">
                        ...
                        <img className="bg-green-500 object-cover h-full w-full" src={docImage} />
                    </div>
            ...
            <div className="w-full p-8">
                <div className="w-full   p-3 flex gap-2 relative bg-white rounded-sm shadow-black shadow-sm ">
                     <div className='w-full   flex flex-col justify-center gap-1 relative'>
                        <p className="w-full font-light text-[14px] md:text-[16px] ">Time:<span>12:30pm</span></p>

                        <p className="w-full text-[14px] md:text-[16px] font-light">Date:<span> 9th December,2024</span></p>
            ...
            <div className="w-full mt-3 h-[200px] flex justify-center place-items-center">
             ...
             <p className=" text-cosmic-color-green-color">Confirmed</p>
             </div>
