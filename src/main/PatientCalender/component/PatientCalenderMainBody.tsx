...
const PatientCalendarMainBody = () => {
  ...
  return (
    <div className="w-full font-poppins flex h-dvh overflow-hidden">
      ...
      <div className=" w-full md:w-[75vw] overflow-y-auto">
        ...
        <div className="m-6 flex justify-end  ">
          <div className="w-fit bg-cosmic-primary-color flex px-8 rounded-md">
            ...
            <p
              className=" w-fit p-2 rounded-md text-white"
              onClick={() => {
        ...
        <div className="w-full md:m-6 flex cursor-default justify-center gap-2 p-1">
          <p
            className={`${activeState.calendar ? "bg-cosmic-primary-color text-white" : "border text-black"} p-2 w-[150px] xs:text-[14px] text-center  rounded-md `}
            onClick={() => {
              setActiveState({
                ...activeState,
                calendar: true,
          ...
          <p
            className={`${activeState.upcoming ? "bg-cosmic-primary-color text-white" : "border text-black"} p-2 w-[150px] xs:text-[14px] text-center  rounded-md `}
            onClick={() => {
              setActiveState({
                ...activeState,
                calendar: false,
          ...
          <p
            className={`${activeState.past ? "bg-cosmic-primary-color text-white" : "border text-black"} p-2 w-[150px] xs:text-[14px] text-center  rounded-md `}
            onClick={() => {
              setActiveState({
                ...activeState,
                calendar: false,
          ...
          <p
            className={`${activeState.cancelled ? "bg-cosmic-primary-color text-white" : "border text-black"} p-2 w-[150px] xs:text-[14px] text-center  rounded-md `}
            onClick={() => {
              setActiveState({
                ...activeState,
                calendar: false,
