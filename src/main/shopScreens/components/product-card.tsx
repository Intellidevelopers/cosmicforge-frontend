...
const ProductCard = (props:product) => {
  ...
  return (
        <div className=" w-[100%] border p-2 rounded-md space-y-1.5  self-center justify-self-center max-w-[140px] md:w-full md:max-w-[200px] md:min-w-[190px] flex flex-1 flex-col justify-center items-center cursor-pointer" onClick={()=>{navigate(`products/${props.title}`)}}>
            ...
            <div className="md:min-w-[90%] w-full space-y-1.5">
              <div className="flex justify-between ">
                ...
                <i className={` fa-heart  ${props.favorite? 'fas text-red-800' : 'far'}`}></i>
              </div>
