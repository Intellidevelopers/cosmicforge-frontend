    ...
    <>
      ...
      <div className="flex flex-col h-[80%]">
        ...
        <div className="m-4 p-4 flex flex-col gap-4 ">
          ...
          <div
            title="Add Card"
            className="flex self-end justify-center items-center cursor-pointer bg-cosmic-primary-color w-4 h-4 rounded-full p-4"
            onClick={() => {
              navigate("/patient/shop/add-card");
            }}
          >
        ...
        <button
          type="button"
          className="rounded-md self-center justify-self-end text-white bg-cosmic-primary-color p-2 w-[250px]"
