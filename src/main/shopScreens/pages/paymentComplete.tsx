...
const PaymentComplete = () => {
  ...
  return (
    <div>
      <HomeMobileNavBar
        title={paymentType === "card" ? "Card Payment" : "Transfer Payment"}
        onSearchFired={() => {}}
      />
      <HomeNavBar
        title={paymentType === "card" ? "Card Payment" : "Transfer Payment"}
      ...
      <div className="flex flex-col gap-2 mt-4">
        <div className="border rounded-lg shadow-md m-4 px-4 h-fit">
          <div className="flex flex-col items-center relative justify-center border-b w-full p-8 border-slate-200">
            ...
            <p className="text-sm bg-cosmic-primary-color opacity-50 w-fit rounded-md p-1">
              Cart
            </p>
          </div>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          <button
            type="button"
            className="bg-cosmic-primary-color rounded-md p-2 w-[200px] h-fit text-white font-bold"
          >
            {" "}
            View Receipt
          </button>
          <button
            type="button"
            className="bg-cosmic-primary-color rounded-md p-2 w-[200px] h-fit text-white font-bold opacity-50"
          >
            {" "}
            Download Receipt
          </button>
