...
const DetailsPage = () => {
  ...
  useEffect(() => {
    if (product && fetchedProducts) {
      const p: product | undefined = fetchedProducts.find(
  ...
  return (
    <>
      <HomeMobileNavBar title={"Details"} onSearchFired={() => {}} />
      <HomeNavBar title={"Details"} onSearchFired={() => {}} />
        ...
        <div className="md:w-1/2 lg:w-[40%] flex flex-col gap-8 py-2">
          ...
          <div className="flex flex-col">
            ...
            <p className="font-poppins">
              ...
              repellat ad veritatis odit et ab recusandae sunt tempore fuga? Eum
              iure nemo aperiam. Modi nihil iure facilis labore nulla atque
              amet, repudiandae delectus! Tenetur vel similique eius at
              explicabo voluptatibus quae nobis rem consequatur nostrum, velit
              laborum placeat fugiat inventore.
            </p>
          </div>
          ...
          <div className="flex justify-between max-w-[200px]">
            ...
            <button
              type="button"
              className="bg-cosmic-primary-color px-2 py-1 cursor-pointer font-bold text-white rounded text-xs"
            >
              Buy Now
            </button>
          </div>
