  ...
  return (
    <div className="w-full  h-dvh overflow-hidden  relative">
      ...
      <div
        ...
        className="bg-cosmic-bg-chat-background   h-dvh  relative   "
      >
        <div
          className={`w-full  h-full  relative ${chatSelected ? "block" : "hidden"} `}
        >
          ...
          <div className="w-full h-[90vh] flex flex-col  ">
            <div
              ...
              className="bg-transparent  h-[70vh]  overflow-y-auto "
            >
              {messages?.length &&
                messages?.length > 0 &&
                messages.map((data, i) => (
...
"
                >
                  ...
                  <textarea
                    ...
                    value={typedMessage}
                    className=" w-full outline-none resize-none h-[60px] p-2 overflow-y-auto  "
                    onChange={(e) => {
