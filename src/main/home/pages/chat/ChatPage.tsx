...
import micIcon from '../../../../assets/icons/cosmic-mute-mic.svg'
        ...
        <div className=" place-items-center md:gap-3  flex  bg-white h-[80px] md:m-2 md:ps-4 " onClick={() => {
            ...
            <div className="w-fit ps-2 md:ms-7  md:p-3 flex justify-center place-items-center gap-2 relative ">
                ...
                <div className='w-full   flex flex-col justify-center  gap-1 relative'>
                    <p className="w-[180px] md:w-full overflow-hidden text-nowrap text-ellipsis text-[12px] md:text-[16px] font-bold ">{"Grace has an Appointment djdjdj"}</p>
                    <p className="w-[180px] md:w-full overflow-hidden text-nowrap text-ellipsis  text-[12px] md:text-[16px] font-light">{"Grace has an Appointment"}</p>
