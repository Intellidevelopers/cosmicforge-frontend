...
const NewCallUIPage = ({
  ...
  return (
    <div
      ref={bodyRef}
      className={`  cursor-default  w-full h-fit flex  absolute bg-transparent   top-0  z-[800] p-8    justify-center`}
    >
      <div
        className={` ${newCall ? "flex" : "hidden"}  bg-white rounded-md p-3 h-[10
