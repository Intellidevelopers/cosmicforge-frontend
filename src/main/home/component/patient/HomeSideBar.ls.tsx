    ...
    <div className="  h-dvh overflow-y-auto bg-home-slidder-color shadow-md shadow-black/20   p-4 z-50 hidden md:flex cursor-default">
      <div className="w-full ">
        ...
        <div className="user-profile-container w-full flex flex-col gap-4  justify-center place-items-center mt-2 ">
          ...
          <p
            className={`${activeRoutePath.isProfileActive && "underline decoration-cosmic-primary-color"}  font-extralight text-cosmic-primary-color hover:underline hover:decoration-cosmic-primary-color `}
            onClick={() => {
          ...
          <div className="nav-bar-links-container  w-full flex flex-col items-center gap-2">
            <div
              className={`w-full flex justify-start transition-all duration-200 ease-out pl-[15%]  place-items-center gap-4 ${activeRoutePath.isHomeActive ? "opacity-100 pl-[15%]  text-cosmic-primary-color  bg-cosmic-color-nav-active p-1 rounded-md  shadow-gray-400 shadow-md font-semibold" : "opacity-50"} text-cosmic-color-lightBlue  hover:opacity-100 hover:text-cosmic-primary-color  hover:bg-cosmic-color-nav-active hover:cursor-pointer rounded-md pl-[15%]  hover:shadow-gray-400 hover:shadow-md p-1`}
              onClick={() => {
                setActiveRoutePath({
                  ...activeRoutePath,
                  isHomeActive: true,
            ...
            <div
              className={`w-full flex justify-start transition-all duration-200 ease-out  place-items-center gap-4 ${activeRoutePath.isRunDiagnosisActive ? "opacity-100 text-cosmic-primary-color  bg-cosmic-color-nav-active p-1 rounded-md  shadow-gray-400 shadow-md font-semibold pl-[15%] " : "opacity-50"} pl-[15%]  text-cosmic-color-lightBlue  hover:opacity-100 hover:text-cosmic-primary-color  hover:bg-cosmic-color-nav-active hover:cursor-pointer rounded-md  hover:shadow-gray-400 hover:shadow-md p-1`}
              onClick={() => {
                setActiveRoutePath({
                  ...activeRoutePath,
                  isHomeActive: false,
            ...
            <div
              className={`w-full flex justify-start transition-all duration-200 ease-out  place-items-center gap-4 ${activeRoutePath.isMessageActive ? "opacity-100 text-cosmic-primary-color  bg-cosmic-color-nav-active p-1 rounded-md  shadow-gray-400 shadow-md font-semibold pl-[15%] " : "opacity-50"} pl-[15%]  text-cosmic-color-lightBlue   hover:opacity-100 hover:text-cosmic-primary-color  hover:bg-cosmic-color-nav-active hover:cursor-pointer rounded-md  hover:shadow-gray-400 hover:shadow-md p-1`}
              onClick={() => {
                setActiveRoutePath({
                  ...activeRoutePath,
                  isHomeActive: false,
            ...
            <div
              className={`w-full flex justify-start transition-all duration-200 ease-out  place-items-center gap-4 ${activeRoutePath.isBookAppoinmentActive ? "opacity-100 text-cosmic-primary-color  bg-cosmic-color-nav-active p-1 rounded-md  shadow-gray-400 shadow-md font-semibold pl-[15%] " : "opacity-50"} pl-[15%]  text-cosmic-color-lightBlue   hover:opacity-100 hover:text-cosmic-primary-color  hover:bg-cosmic-color-nav-active hover:cursor-pointer rounded-md  hover:shadow-gray-400 hover:shadow-md p-1`}
              onClick={() => {
                setActiveRoutePath({
                  ...activeRoutePath,
                  isHomeActive: false,
            ...
            <div
              className={`w-full flex justify-start transition-all duration-200 ease-out  place-items-center gap-4 ${activeRoutePath.isAnalyticsActive ? "opacity-100 text-cosmic-primary-color  bg-cosmic-color-nav-active p-1 rounded-md  shadow-gray-400 shadow-md font-semibold pl-[15%] " : "opacity-50"} pl-[15%]  text-cosmic-color-lightBlue  hover:opacity-100 hover:text-cosmic-primary-color  hover:bg-cosmic-color-nav-active hover:cursor-pointer rounded-md  hover:shadow-gray-400 hover:shadow-md p-1`}
              onClick={() => {
                setActiveRoutePath({
                  ...activeRoutePath,
                  isHomeActive: false,
            ...
            <div
              className={`w-full flex justify-start transition-all duration-200 ease-out  place-items-center gap-4 ${activeRoutePath.isFirstAidActive ? "opacity-100 text-cosmic-primary-color  bg-cosmic-color-nav-active p-1 rounded-md  shadow-gray-400 shadow-md font-semibold pl-[15%] " : "opacity-50"} pl-[15%]  text-cosmic-color-lightBlue   hover:opacity-100 hover:text-cosmic-primary-color  hover:bg-cosmic-color-nav-active hover:cursor-pointer rounded-md  hover:shadow-gray-400 hover:shadow-md p-1`}
              onClick={() => {
                setActiveRoutePath({
                  ...activeRoutePath,
                  isHomeActive: false,
            ...
            <div
              className={`w-full flex justify-start transition-all duration-200 ease-out  place-items-center gap-4 ${activeRoutePath.isChatBotActive ? "opacity-100 text-cosmic-primary-color  bg-cosmic-color-nav-active p-1 rounded-md  shadow-gray-400 shadow-md font-semibold pl-[15%] " : "opacity-50"} pl-[15%]  text-cosmic-color-lightBlue  hover:opacity-100 hover:text-cosmic-primary-color  hover:bg-cosmic-color-nav-active hover:cursor-pointer rounded-md  hover:shadow-gray-400 hover:shadow-md p-1`}
              onClick={() => {
                setActiveRoutePath({
                  ...activeRoutePath,
                  isHomeActive: false,
            ...
            <div
              className={`w-full flex justify-start transition-all duration-200 ease-out  place-items-center gap-4 ${activeRoutePath.isFindASpecialistActive ? "opacity-100 text-cosmic-primary-color  bg-cosmic-color-nav-active p-1 rounded-md  shadow-gray-400 shadow-md font-semibold pl-[15%] " : "opacity-50"} pl-[15%]  text-cosmic-color-lightBlue  hover:opacity-100 hover:text-cosmic-primary-color  hover:bg-cosmic-color-nav-active hover:cursor-pointer rounded-md  hover:shadow-gray-400 hover:shadow-md p-1`}
              onClick={() => {
                setActiveRoutePath({
                  ...activeRoutePath,
                  isHomeActive: false,
            ...
            <div
              className={`w-full flex justify-start transition-all duration-200 ease-out  place-items-center gap-4 ${activeRoutePath.isCalenderActive ? "opacity-100 text-cosmic-primary-color  bg-cosmic-color-nav-active p-1 rounded-md  shadow-gray-400 shadow-md font-semibold pl-[15%] " : "opacity-50"} pl-[15%]  text-cosmic-color-lightBlue  hover:opacity-100 hover:text-cosmic-primary-color  hover:bg-cosmic-color-nav-active hover:cursor-pointer rounded-md  hover:shadow-gray-400 hover:shadow-md p-1`}
              onClick={() => {
                setActiveRoutePath({
                  ...activeRoutePath,
                  isHomeActive: false,
            ...
            <div
              className={`w-full flex justify-start transition-all duration-200 ease-out  place-items-center gap-4 ${activeRoutePath.isSettingsActive ? "opacity-100 text-cosmic-primary-color  bg-cosmic-color-nav-active p-1 rounded-md  shadow-gray-400 shadow-md font-semibold pl-[15%] " : "opacity-50"} pl-[15%]  text-cosmic-color-lightBlue   hover:opacity-100 hover:text-cosmic-primary-color  hover:bg-cosmic-color-nav-active hover:cursor-pointer rounded-md  hover:shadow-gray-400 hover:shadow-md p-1`}
              onClick={() => {
                setActiveRoutePath({
                  ...activeRoutePath,
                  isHomeActive: false,
