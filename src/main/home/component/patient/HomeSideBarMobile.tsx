...
import useGetSideBarMobileAnimation, {
  closeSideBar,
} from "../../hook/patient/useGetSideBarMobileAnimation";
...
const HomeSideBarMobile = () => {
  ...
  return (
    <div
      ref={sideBarRef}
      className="hidden md:hidden w-[60%] h-dvh overflow-y-auto bg-home-slidder-color shadow-md shadow-black absolute left-0  p-4 z-[200]  cursor-default "
    >
      <div className="w-full ">
        <i
          className="fa fa-times fa-xl absolute right-1 p-2 "
          aria-hidden="true"
          onClick={() => {
            closeSideBar();
          }}
        ...
        <div className="user-profile-container w-full flex flex-col gap-1  justify-center place-items-center mt-2 ">
          ...
          <div className="nav-bar-links-container  w-full flex flex-col justify-center place-items-center gap-4">
            ...
            <div
              className={`w-full flex justify-start ms-5  place-items-center gap-4 ${activeRoutePath.isRunDiagnosisActive ? "opacity-100 text-cosmic-primary-color  bg-cosmic-color-nav-active p-1 rounded-md  shadow-black shadow-lg font-semibold" : "opacity-50"} text-cosmic-color-lightBlue  hover:opacity-100 hover:text-cosmic-primary-color  hover:bg-cosmic-color-nav-active hover:p-1 rounded-md  hover:shadow-black hover:shadow-lg hover:font-semibold`}
              onClick={() => {
                setActiveRoutePath({
                  ...activeRoutePath,
                  isHomeActive: false,
            ...
            <div
              className={`w-full flex justify-start ms-5  place-items-center gap-4 ${activeRoutePath.isMessageActive ? "opacity-100 text-cosmic-primary-color  bg-cosmic-color-nav-active p-1 rounded-md  shadow-black shadow-lg font-semibold" : "opacity-50"} text-cosmic-color-lightBlue   hover:opacity-100 hover:text-cosmic-primary-color  hover:bg-cosmic-color-nav-active hover:p-1 rounded-md  hover:shadow-black hover:shadow-lg hover:font-semibold`}
              onClick={() => {
                setActiveRoutePath({
                  ...activeRoutePath,
                  isHomeActive: false,
            ...
            <div
              className={`w-full flex justify-start ms-5  place-items-center gap-4 ${activeRoutePath.isBookAppoinmentActive ? "opacity-100 text-cosmic-primary-color  bg-cosmic-color-nav-active p-1 rounded-md  shadow-black shadow-lg font-semibold" : "opacity-50"} text-cosmic-color-lightBlue   hover:opacity-100 hover:text-cosmic-primary-color  hover:bg-cosmic-color-nav-active hover:p-1 rounded-md  hover:shadow-black hover:shadow-lg hover:font-semibold`}
              onClick={() => {
                setActiveRoutePath({
                  ...activeRoutePath,
                  isHomeActive: false,
            ...
            <div
              className={`w-full flex justify-start ms-5  place-items-center gap-4 ${activeRoutePath.isAnalyticsActive ? "opacity-100 text-cosmic-primary-color  bg-cosmic-color-nav-active p-1 rounded-md  shadow-black shadow-lg font-semibold" : "opacity-50"} text-cosmic-color-lightBlue  hover:opacity-100 hover:text-cosmic-primary-color  hover:bg-cosmic-color-nav-active hover:p-1 rounded-md  hover:shadow-black hover:shadow-lg hover:font-semibold`}
              onClick={() => {
                setActiveRoutePath({
                  ...activeRoutePath,
                  isHomeActive: false,
            ...
            <div
              className={`w-full flex justify-start ms-5  place-items-center gap-4 ${activeRoutePath.isFirstAidActive ? "opacity-100 text-cosmic-primary-color  bg-cosmic-color-nav-active p-1 rounded-md  shadow-black shadow-lg font-semibold" : "opacity-50"} text-cosmic-color-lightBlue   hover:opacity-100 hover:text-cosmic-primary-color  hover:bg-cosmic-color-nav-active hover:p-1 rounded-md  hover:shadow-black hover:shadow-lg hover:font-semibold`}
              onClick={() => {
                setActiveRoutePath({
                  ...activeRoutePath,
                  isHomeActive: false,
            ...
            <div
              className={`w-full flex justify-start ms-5  place-items-center gap-4 ${activeRoutePath.isChatBotActive ? "opacity-100 text-cosmic-primary-color  bg-cosmic-color-nav-active p-1 rounded-md  shadow-black shadow-lg font-semibold" : "opacity-50"} text-cosmic-color-lightBlue  hover:opacity-100 hover:text-cosmic-primary-color  hover:bg-cosmic-color-nav-active hover:p-1 rounded-md  hover:shadow-black hover:shadow-lg hover:font-semibold`}
              onClick={() => {
                setActiveRoutePath({
                  ...activeRoutePath,
                  isHomeActive: false,
            ...
            <div
              className={`w-full flex justify-start ms-5  place-items-center gap-4 ${activeRoutePath.isFindASpecialistActive ? "opacity-100 text-cosmic-primary-color  bg-cosmic-color-nav-active p-1 rounded-md  shadow-black shadow-lg font-semibold" : "opacity-50"} text-cosmic-color-lightBlue  hover:opacity-100 hover:text-cosmic-primary-color  hover:bg-cosmic-color-nav-active hover:p-1 rounded-md  hover:shadow-black hover:shadow-lg hover:font-semibold`}
              onClick={() => {
                setActiveRoutePath({
                  ...activeRoutePath,
                  isHomeActive: false,
            ...
            <div
              className={`w-full flex justify-start ms-5  place-items-center gap-4 ${activeRoutePath.isCalenderActive ? "opacity-100 text-cosmic-primary-color  bg-cosmic-color-nav-active p-1 rounded-md  shadow-black shadow-lg font-semibold" : "opacity-50"} text-cosmic-color-lightBlue  hover:opacity-100 hover:text-cosmic-primary-color  hover:bg-cosmic-color-nav-active hover:p-1 rounded-md  hover:shadow-black hover:shadow-lg hover:font-semibold`}
              onClick={() => {
                setActiveRoutePath({
                  ...activeRoutePath,
                  isHomeActive: false,
            ...
            <div
              className={`w-full flex justify-start ms-5  place-items-center gap-4 ${activeRoutePath.isSettingsActive ? "opacity-100 text-cosmic-primary-color  bg-cosmic-color-nav-active p-1 rounded-md  shadow-black shadow-lg font-semibold" : "opacity-50"} text-cosmic-color-lightBlue   hover:opacity-100 hover:text-cosmic-primary-color  hover:bg-cosmic-color-nav-active hover:p-1 rounded-md  hover:shadow-black hover:shadow-lg hover:font-semibold`}
              onClick={() => {
                setActiveRoutePath({
                  ...activeRoutePath,
                  isHomeActive: false,
