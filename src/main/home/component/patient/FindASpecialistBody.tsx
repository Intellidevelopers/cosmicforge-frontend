    ...
    <div className=" w-full  relative  h-dvh overflow-x-hidden    overflow-y-auto flex flex-col cursor-default">
        ...
        if (path === "Find A Specialist") {
          ...
          if (query && specialistCache) {
            ...
            const filter = specialistCache.filter(specialist => {
              ...
              return new RegExp(`^${query.toLocaleLowerCase()}`).test(specialist.name?.toLocaleLowerCase()!!)


            })

            if (filter.length > 0) {
              setSpecialist(filter as [{
                name?: string;
                image?: string;
                backgroundImage?: string;
                bodyText?: string;
      ...
      <div className=" ps-0   pe-10   ">
        ...
        <div className="w-full h-full ">
          ...
          {
            !loading && specialist === null && <div className="w-full h-[100vh] flex justify-center place-items-center ">
