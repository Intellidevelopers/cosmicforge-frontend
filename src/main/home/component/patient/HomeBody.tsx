  ...
  return (
    <div className=" w-full  relative  h-dvh overflow-x-hidden    overflow-y-auto flex flex-col">
      ...
      <div className=" md:ps-[294px] ">
        <div className="w-full  md:justify-center  mt-5  inline-flex overflow-x-auto">
          <img
            src={aiImage}
        ...
        <div className="relative ps-7 w-full " >
          <div className="relative m-3 flex gap-4 place-items-center w-[92%]">
            <p className="font-bold min-w-fit">Wellness Product</p>

            <p className="absolute right-3  md:relative  font-extralight min-w-fit text-cosmic-color-lightBlue">see more</p>
