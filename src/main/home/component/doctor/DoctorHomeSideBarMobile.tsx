...
const DoctorHomeSideBarMobile = () => {
    ...
    return (
        <div ref={sideBarRef} className="hidden  w-[60%] absolute h-dvh overflow-y-auto bg-home-slidder-color shadow-xsm shadow-black   p-4 z-[300] cursor-default">
