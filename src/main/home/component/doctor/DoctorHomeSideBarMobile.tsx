...
const DoctorHomeSideBarMobile = () => {
  const { activeRoutePath, setActiveRoutePath } =
    useGetDoctorActiveNavbarRoute();
  ...
  return (
    <div
      ref={sideBarRef}
      className="hidden  w-[60%] absolute h-dvh overflow-y-auto bg-home-slidder-color shadow-xsm shadow-black   p-4 z-[300] cursor-default"
    >
      <div className="w-full mt-4 ">
        ...
        <div className="user-profile-container w-full flex flex-col gap-4  justify-center place-items-center mt-2 ">
          ...
          <p
            className={`font-extralight text-cosmic-primary-color ${activeRoutePath.isEditProfileActive && "underline"}`}
            onClick={() => {
              setActiveRoutePath({
                ...activeRoutePath,
                isHomeActive: false,
          ...
          <div className="nav-bar-links-container w-full flex flex-col justify-center place-items-center gap-5">
            <div
              className={`w-full flex justify-start ms-5  place-items-center gap-4 ${activeRoutePath.isHomeActive ? "opacity-50 text-cosmic-primary-color  bg-cosmic-color-nav-active p-1 rounded-md shadow-black shadow-xsm font-semibold" : "opacity-50"} text-cosmic-color-lightBlue  hover:opacity-100 hover:text-cosmic-primary-color  hover:bg-cosmic-color-nav-active hover:p-1 rounded-md  hover:shadow-black hover:shadow-sm hover:font-semibold`}
              onClick={() => {
                setActiveRoutePath({
                  ...activeRoutePath,
                  isHomeActive: true,
            ...
            <div
              className={`w-full flex justify-start ms-5  place-items-center gap-4 ${activeRoutePath.isProfileActive ? "opacity-100 text-cosmic-primary-color  bg-cosmic-color-nav-active p-1 rounded-md  shadow-black shadow-sm font-semibold" : "opacity-50"} text-cosmic-color-lightBlue  hover:opacity-50 hover:text-cosmic-primary-color  hover:bg-cosmic-color-nav-active hover:p-1 rounded-md  hover:shadow-black hover:shadow-sm hover:font-semibold`}
              onClick={() => {
                setActiveRoutePath({
                  ...activeRoutePath,
                  isHomeActive: false,
