        ...
        <div className="user-profile-container w-full flex flex-col gap-4  justify-center place-items-center mt-2 ">
          ...
          <p>
            ...
            <span className="text-sm font-light">
              {user.data?.profile?.userCosmicID}
            </span>
          </p>
          ...
          <div className="nav-bar-links-container w-full flex flex-col justify-center place-items-center gap-5">
            ...
            <div
              className={`w-full flex justify-start ps-[16%] ms-5 min-h-10  place-items-center gap-4 ${activeRoutePath.isMessageActive ? "opacity-100 text-cosmic-primary-color  bg-cosmic-color-nav-active p-1 rounded-md  shadow-black shadow-sm font-semibold" : "opacity-50"} text-cosmic-color-lightBlue   hover:opacity-50 hover:text-cosmic-primary-color  hover:bg-cosmic-color-nav-active  rounded-md  hover:shadow-black hover:shadow-sm hover:font-semibold`}
              onClick={() => {
                setActiveRoutePath({
                  ...activeRoutePath,
                  isHomeActive: false,
            ...
            <div
              className={`w-full flex ps-[16%] justify-start min-h-10  ms-5  place-items-center gap-4 ${activeRoutePath.isAnalyticsActive ? "opacity-100 text-cosmic-primary-color  bg-cosmic-color-nav-active p-1 rounded-md  shadow-black shadow-sm font-semibold" : "opacity-50"} text-cosmic-color-lightBlue  hover:opacity-50 hover:text-cosmic-primary-color  hover:bg-cosmic-color-nav-active  rounded-md  hover:shadow-black hover:shadow-sm  hover:font-semibold`}
              onClick={() => {
                setActiveRoutePath({
                  ...activeRoutePath,
                  isHomeActive: false,
            ...
            <div
              className={`w-full flex ps-[16%] justify-start ms-5 min-h-10  place-items-center gap-4 ${activeRoutePath.isProfileActive ? "opacity-100 text-cosmic-primary-color  bg-cosmic-color-nav-active p-1 rounded-md  shadow-black shadow-sm font-semibold" : "opacity-50"} text-cosmic-color-lightBlue  hover:opacity-50 hover:text-cosmic-primary-color  hover:bg-cosmic-color-nav-active  rounded-md  hover:shadow-black hover:shadow-sm hover:font-semibold`}
              onClick={() => {
                setActiveRoutePath({
                  ...activeRoutePath,
                  isHomeActive: false,
