    ...
    <div className="h-screen w-screen bg-gray-100 md:px-0 px-[5%] flex flex-col justify-center items-center">
      ...
      <div className="md:w-[400px] md:h-fit h-screen md:text-center text-left flex flex-col md:pb-0 pb-[10%] justify-between items-center md:justify-around md:pt-0 pt-[20%]  gap-[15px] w-[100%]">
        ...
        <div className="flex flex-col gap-2 w-[100%]">
          ...
          <div className="mt-[20px] text-left">
            ...
            <input
              ...
              className="w-[100%] px-[10px] outline-none rounded-[5px] bg-gray-300 md:h-[48px] mt-[5px] h-[50px]"
            />
          </div>
          <span
        ...
        <button
          ...
          className={`${isLoading ? "bg-[#272EA7]/80" : "bg-[#272EA7]"} h-[48px] w-[100%] md:mt-[190px] hover:bg-[#272EA7]/80 text-white font-bold flex flex-row justify-center items-center rounded-[5px]`}
        >
