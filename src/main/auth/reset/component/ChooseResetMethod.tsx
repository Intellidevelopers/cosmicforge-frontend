        ...
        <div className="h-screen w-screen bg-gray-100 md:px-0 px-[5%] flex flex-col justify-center items-center">
            ...
            <div className="md:w-[400px] md:h-fit h-screen md:text-center text-left flex flex-col md:pb-0 pb-[10%] justify-between items-center md:justify-around md:pt-0 pt-[20%]  gap-[15px] w-[100%]">
                ...
                <div className="flex flex-col md:gap-[50px] gap-[20px] w-[100%] text-center">
                    <button onClick={toNextScreen} className={`bg-[#272EA7] h-[48px] w-[100%] md:mt-[190px] hover:bg-[#272EA7]/80 text-white font-bold flex flex-row justify-center items-center rounded-[5px]`}>
                        Email address
                    </button> 
                    <span className="text-black text-[15px]">Don&apos;t have an account? <Link className="text-[#272EA7] hover:text-[#272EA7]/50" to={'/account/signup/verify-email'}>Sign Up</Link></span>
                </div>
