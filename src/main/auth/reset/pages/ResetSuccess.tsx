        ...
        <div className="flex flex-row bg-gray-100 py-[50px] md:px-[25px] justify-center h-screen w-screen">
            <div className="flex-col items-center justify-between mt-[10%] md:mt-0 h-[90%] flex md:w-[400px] w-[90%] md:h-fit">
                ...
                <div className="flex flex-col">
                    <span className="text-[23px] md:text-[17px] font-bold self-center mt-2">Success!</span>
                    <span className="mt-2 text-[17px] md:text-[16px] self-center">You have successfully reset your password.</span>
                </div>
                ...
                <div className="mt-[17px] w-[100%] flex flex-col items-center gap-2">
                    <Link to={'/account/login'} className="md:h-[40px] flex flex-col justify-center items-center h-[45px] md:w-[100%] mt-[20px] w-[90%] rounded-[5px] hover:bg-[#272EA7]/70 bg-[#272EA7] cursor-pointer text-white">Back to Log In</Link>
                </div>
            </div>
        </div>
    )
