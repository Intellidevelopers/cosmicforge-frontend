...
const EnterPersonalDetails: React.FC = () => {
    ...
    const startReg = (e:React.KeyboardEvent<HTMLFormElement>) =>{
        e.preventDefault();
    ...
    return (
        <div className="flex flex-row bg-gray-100 py-[50px] justify-center h-screen w-screen">
            ...
            <div className="flex-col items-center mt-[10%] md:mt-0 h-[90%] flex md:w-[400px] w-[90%] md:h-fit">
                ...
                <form onSubmit={startReg} className="mt-[17px] w-[100%] flex flex-col gap-[20px] md:gap-2">
                    ...
                    <button type="submit" className="md:h-[40px] h-[45px] md:w-[100%] md:mt-0 mt-[20px] md:ml-0 ml-[5%] w-[90%] rounded-[5px] hover:bg-[#272EA7]/70 bg-[#272EA7] cursor-pointer text-white">Sign Up</button>
                </form>
