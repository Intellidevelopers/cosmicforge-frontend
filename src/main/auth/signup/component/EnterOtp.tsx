      ...
      <div className="md:w-[400px] md:h-fit h-screen md:text-center text-left  mt-6 flex flex-col md:pb-0 pb-[10%] justify-between items-center md:justify-around md:pt-0 pt-[30px]  gap-[15px] w-[100%]">
        ...
        <div className="flex flex-col place-items-center gap-2 w-[100%] mt-[30px]">
          ...
          <div className="w-full mt-[6px] justify-center place-items-center font-light gap-2 flex">
            ...
            <button
              className={`${!counter.startsWith("0") ? "text-gray-50" : "text-[#272EA7] hover:underline decoration-blue-600 "}  text-[16px] w-fit`}
              disabled={!counter.startsWith("0") && !counter.endsWith("0")}
              onClick={async () => {
                setErrorMesage("");
                stopAndClearTimer();
                if (
        ...
        <div className="w-[100%]">
          <button
            onClick={confirmOtp}
            className="h-[48px] w-[100%] mt-[50px] bg-[#272EA7] hover:bg-[#272EA7]/80 text-white font-bold flex flex-row justify-center items-center rounded-[5px]"
          >
            Continue
          </button>
