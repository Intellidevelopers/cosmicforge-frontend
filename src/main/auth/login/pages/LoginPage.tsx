...
const LoginPage: React.FC = () => {
    ...
    const [makePasswordInVisible, setMakePasswordInVisible] = useState<boolean>(true)
   ...
   const passwordRef:MutableRefObject<HTMLInputElement | null> = useRef(null)
    ...
    return (<div className="flex flex-row bg-gray-100 py-[50px] justify-center h-screen w-screen">

        <button onClick={() => { navigate(-1) }} className="flex absolute md:top-[50px] top-[5%] flex-row gap-2 items-center font-bold md:w-[80%] w-[95%] h-fit">
        ...
        <div className="flex-col items-center mt-[10%] md:mt-8 h-[90%] flex md:w-[400px] w-[90%] md:h-fit">
            ...
            <div onSubmit={startReg} className="mt-[17px] w-[100%] flex flex-col gap-3 md:gap-2">
                ...
                <div className="flex flex-col gap-1 relative">
                    ...
                    {
                        !makePasswordInVisible && <i className="fa fa-eye absolute top-[60%] right-3" onClick={() => {
                            setMakePasswordInVisible(true)
                        }} />
                    }

                    {
                        makePasswordInVisible && <i className="fa fa-eye-slash absolute top-[60%] right-3" onClick={() => {
            ...
            <div className="flex flex-col gap-[15px] mt-[30px] w-[100%] items-center">
                <div className="flex flex-row gap-[20px] w-[100%] justify-center items-center">
                    ...
                    <button className="w-[55px] h-[55px] md:w-[40px] md:h-[40px] hover:scale-[105%] flex flex-col justify-center items-center border-[1px] border-gray-300 rounded-[4px]" onClick={async () => {
                        try {
                            console.log('firing.........')
                            const token = (await sign_up_user_wih_google({ authType: "login" })).data
