...
const ReviewCard = ({ clientName,
    clientProfile,
    time,
    comment }: ReviewCardProps) => {



    return <div className="w-full m-2 p-3 flex gap-2 relative bg-white rounded-md shadow">
        <img className='w-[50px] h-[50px] rounded-full' alt='card-profile' src={clientProfile} />
        <div className='w-full flex flex-col gap-1 relative'>
            ...
            <p className='font-extralight text-[12px] absolute right-0 top-1'>{time}</p>
        </div>
    </div>
}
